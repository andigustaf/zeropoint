                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <VStack align={'stretch'}>
                            {data?.clockInData && (
                                <Stack direction={['column', 'row']} align={'stretch'} border="2px"
                                       borderStyle={'dashed'} borderColor="primary.50" rounded="8" p="2" spacing={'4'}>
                                    <Image h={['100%', 200]} w={['100%', 200]} rounded="8"
                                           src={data?.clockInData?.image_url} fallbackSrc={defaultImage}
                                    ...
                                    <VStack w="full" align={'stretch'}>
                                        ...
                                        <SimpleGrid columns={2} spacing={4}>
                                            ...
                                            <VStack align={'stretch'} spacing="0">
                                                ...
                                                <Text
                                                    fontSize={'sm'}>{format(data?.clockInData?.timestamp?.toDate(), 'ccc, dd MMM yyyy')}</Text>
                                            </VStack>
                                            <VStack align={'stretch'} spacing="0">
                                            ...
                                            <VStack align={'stretch'} spacing="0">
                                                ...
                                                <Box>
                                                    <Badge
                                                        colorScheme={data?.attendanceStatus == 'WFO' ? 'green' : 'blue'}>{data?.attendanceStatus}</Badge>
                                                </Box>
                                            </VStack>
                                        </SimpleGrid>
                            ...
                            {data?.clockOutData && (
                                <Stack direction={['column', 'row']} align={'stretch'} border="2px"
                                       borderStyle={'dashed'} borderColor="primary.50" rounded="8" p="2" spacing={'4'}>
                                    <Image h={['100%', 200]} w={['100%', 200]} rounded="8"
                                           src={data?.clockOutData?.image_url} fallbackSrc={defaultImage}
                                           alt={data?.displayName}/>
                                    <VStack w="full" align={'stretch'}>
                                        <Box>
                                        ...
                                        <SimpleGrid columns={2} spacing={4}>
                                            ...
                                            <VStack align={'stretch'} spacing="0">
                                                <Text fontSize={'sm'} fontWeight={'semibold'}>Date</Text>
                                                <Text
                                                    fontSize={'sm'}>{format(data?.clockOutData?.timestamp?.toDate(), 'ccc, dd MMM yyyy')}</Text>
                                            </VStack>
                                            <VStack align={'stretch'} spacing="0">
                                                <Text fontSize={'sm'} fontWeight={'semibold'}>Notes</Text>
                            ...
                            {(!data?.clockInData && !data?.clockOutData) && (
                                <VStack align={'center'} spacing={'8'}>
                                    <Image w="11rem"
                                           src="https://app.smartseller.co.id/assets/img/illustration/no_customer.svg"></Image>
